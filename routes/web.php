...
Route::controller(\App\Http\Controllers\FileController::class)
    ...
    ->group(function () {
        ...
        Route::get('/file/files-shared-with-me', 'sharedWithMe')->name('file.sharedWithMe');
        Route::get('/file/files-shared-by-me', 'sharedByMe')->name('file.sharedByMe');
        Route::get('/file/download/files-shared-with-me', 'downloadSharedWithMe')->name('file.download.sharedWithMe');
        Route::get('/file/download/files-shared-by-me', 'downloadSharedByMe')->name('file.download.sharedByMe');
        Route::post('/file/share', 'share')->name('file.share');
        Route::post('/file/unshare', 'unshare')->name('file.unshare');
        Route::get('/file/download','download')->name('file.download');
        Route::get('/download/{type}/{public_file_name}','downloadFromStorage')->name('download');
    });
